...
public:
    ...
    /** @return A normalised version of this vector (does not modify the zero vector). */
    ...
    /** Converts this vector to a different vector type
          *
          * @tparam T the vector type to convert to, which must have a constructor taking (x, y, z)
          * @return this vector, converted to the given vector type */
    template <typename T>
    T toVector3() const
    {
        return T(x, y, z);
    ...
    /** Converts this vector to a different vector type
          *
          * @tparam T the vector type to convert to, which must have a constructor taking (x, y, z, w)
          * @param w the fourth value in the resulting vector
          * @return this vector, converted to the given vector type */
    template <typename T>
    T toVector4(float w = 0.0f) const
    {
        return T(x, y, z, w);
    }
